    ...
    fun generateDummySeries(): ArrayList<SeriesEntity> {
        ...
        series.add(
                SeriesEntity(4,
                        ...
                        "R.drawable.serie4",false)
        )
        series.add(SeriesEntity(5,
        ...
        series.add(
                SeriesEntity(9,
                        ...
                        "R.drawable.serie9",false)
        )
        series.add(SeriesEntity(10,
                "Your Lie in April",
